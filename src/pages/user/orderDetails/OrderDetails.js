                ...
                {loading ? (
                  ...
                  <>
                    <div className="d-flex align-items-center justify-content-between ps-3 pe-3 pt-3">
                      <h5 className="">Order # {order._id}</h5>
                      <button>
                        <AiOutlineDownload className={styles.icon} /> Invoice
                      </button>
                    </div>
                    <hr />
                    {/* order status  */}
                      ...
                      <div className="row g-3 mt-3 mb-3">
                        <div className="col-md-3">
                          <div className="d-flex align-items-center justify-content-center flex-column">
                            <FcProcess className={statusClass(0)} size={40} />
                            <p className="mt-2">Processing</p>
                          </div>
                        </div>
                        <div className="col-md-3">
                          <div className="d-flex align-items-center justify-content-center flex-column">
                            <FcInTransit className={statusClass(1)} size={40} />
                            <p className="mt-2">On The Way</p>
                          </div>
                        </div>
                        <div className="col-md-3">
                          <div className="d-flex align-items-center justify-content-center flex-column">
                            <FcShipped className={statusClass(2)} size={40} />
                            <p className="mt-2">Shipped</p>
                          </div>
                        </div>
                        <div className="col-md-3">
                          <div className="d-flex align-items-center justify-content-center flex-column">
                            <FcPaid className={statusClass(3)} size={40} />
                    ...
                    <div className="row p-3">
                      ...
                      <div className="col-md-6">
                        <h5>Shipping Info</h5>
                        <Table className="mt-3 mb-3" borderless responsive>
                          <tbody>
                            <tr>
                              <td>
                            ...
                            <tr>
                              ...
                              <td>{shippingInfo && shippingInfo.address}</td>
                            </tr>
                            <tr>
                              <td>
                                <FaCity size={20} />
                              ...
                              <td>{shippingInfo && shippingInfo.city}</td>
                            </tr>
                          </tbody>
                        </Table>
                      </div>
